...
function displayData(rows) {
    ...
    document.getElementById('iman').innerText = ultimo[21];
    document.getElementById('bateria').innerText = ultimo[22];
    document.getElementById('egopro').innerText = ultimo[23];
    document.getElementById('camara').innerText = ultimo[24];
    document.getElementById('generico').innerText = ultimo[25];
    document.getElementById('estado').innerText = ultimo[26];
    document.getElementById('coment4').innerText = ultimo[27]  == null ? 'Sin Comentarios' : ultimo[20];
